...
const { movieValidationMiddleware } = require('../middlewares/validation/movieValidationMiddleware')
...
router.post('/movies', movieValidationMiddleware(), auth, async (req, res) => {
    try {
...
router.patch('/movies/:id', movieValidationMiddleware(), auth, async (req, res) => {
    try {
